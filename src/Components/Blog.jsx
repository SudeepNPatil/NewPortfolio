          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog, index) => (
              <a
                ...
                className="group shadow-lg rounded-lg  hover:shadow-xl transition-all duration-300 flex flex-col"
              >
                <div className="overflow-hidden border-b border-black rounded-lg">
                  <img
                    src={blog.image}
                    alt={blog.title}
